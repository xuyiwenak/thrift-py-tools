...
class Error(object):
    ...
    def __init__(self, msgId=None, body=None,):
        self.msgId = msgId
        self.body = body
    ...
    def write(self, oprot):
        ...
        if self.msgId is not None:
            oprot.writeFieldBegin('msgId', TType.I32, 1)
            oprot.writeI32(self.msgId)
            oprot.writeFieldEnd()
    ...
    def validate(self):
        if self.msgId is None:
            raise TProtocolException(message='Required field msgId is unset!')
        return
